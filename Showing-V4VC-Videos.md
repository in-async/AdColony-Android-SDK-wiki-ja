...
If your application provides a custom ID to AdColony, you will need to add “&custom_id=[CUSTOM_ID]” to the end your zone’s callback URL or it will not be provided to your server. You will also need to append the custom ID to the end of your verifier string.<br><br>

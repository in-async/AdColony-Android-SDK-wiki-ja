...
* *client_options*
  * A String containing your app version and the origin store (examples: “version=1.1,store:google” or "version=2.23,store:amazon"). Please note that if you are integrating into an Amazon app you will need to replace 'google' with 'amazon' in the client_options String.
* *app_id*  
